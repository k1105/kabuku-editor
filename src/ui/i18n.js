const TRANSLATIONS = {
  ...
  "Import Images": "画像取込",
  "Import from Font": "書体から取込",
  Family: "書体",
  Ranges: "範囲",
  Custom: "任意",
  "Latin (ASCII)": "欧文 (ASCII)",
  Hiragana: "ひらがな",
  Katakana: "カタカナ",
  "Jōyō Kanji": "常用漢字",
  Generate: "生成",
  ...
  "SVG Export": "SVG書き出し",
  "Static Font (.otf)": "静的フォント (.otf)",
  "Variable Font": "バリアブルフォント",
  "Static Font Export": "静的フォント書き出し",
  "Variable Font Export": "バリアブルフォント書き出し",
  "Active layer only": "アクティブなレイヤーのみ",
  "All layers": "全レイヤー",
  "All (ZIP)": "全て (ZIP)",
  Filename: "ファイル名",
  Cancel: "キャンセル",
